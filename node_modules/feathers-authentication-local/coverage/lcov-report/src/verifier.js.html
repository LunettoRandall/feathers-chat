...
&nbsp;
    ...
    this.service.find({ query })
      ...
      .catch(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >error =&gt; error ? done(error) : done(null, error, { message: 'Invalid login' }));</span></span>
  }
}
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Jun 21 2017 14:23:42 GMT-0700 (PDT)
</div>
</div>
