...
90
91
92</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof jwtSettings.secret === 'undefined') {
<span class="cstat-no" title="statement not covered" >      throw new Error(`You must provide a 'secret' in your authentication configuration or pass one explicitly`);</span>
    }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!strategyOptions.algorithms &amp;&amp; strategyOptions.algorithm) {
      strategyOptions.algorithms = A</span>rray.isArray(strategyOptions.algorithm) ? <span class="branch-0 cbranch-no" title="branch not covered" >strategyOptions.algorithm : [strategyOptions.algorithm];
